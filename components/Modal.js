      ...
      <Dialog as="div" className="fixed z-50 inset-0 pt-8" onClose={setIsOpen}>
        <div className="flex items-start justify-center min-h-[800px] sm:min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
          <Transition.Child
            ...
            leaveTo="opacity-0"
          >
            <Dialog.Overlay className="fixed inset-0 backdrop-blur bg-black/10" />
          </Transition.Child>
          ...
          >
            <div className="inline-block align-bottom bg-black rounded-2xl text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-xl sm:w-full">
              <div
                className="flex items-ceter px-1.5 py-2 border-b
              border-gray-700"
              >
                <div
                  ...
                  <div className="mt-7 flex space-x-3 w-full">
                    ...
                    <div className="flex-grow mt-2">
                      <textarea
                        ...
                        rows="2"
                        className="bg-transparent outline-none text-[#9d9d9d] text-lg scrollbar-hide placeholder-gray-500 tracking-wide w-full min-h-[80px]"
                      />
